...
PulseAudio::PulseAudio()
{
    ...
    connect(this, &PulseAudio::source_output_added, this, &PulseAudio::updateSourceOutputCount);
    connect(this, &PulseAudio::source_output_removed, this, &PulseAudio::updateSourceOutputCount);
